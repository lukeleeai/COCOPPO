...
class COCOB(Optimizer):
    ...
    def _create_slots(self, var_list):
        for v in var_list:
            with ops.colocate_with(v):
                ...
                # beta = constant_op.constant(0.0, shape=[], dtype=v.dtype.base_dtype)

            self._zeros_slot(v, "beta", self._name)
            ...
            # self._get_or_make_slot(v, beta, "beta", self._name)
    ...
    def _apply_dense(self, grad, var):
        ...
        beta_update_op = beta.assign(new_w-tilde_w)
