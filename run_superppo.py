...
from algo.superppo import PPOTrain


def argparser():
    parser = argparse.ArgumentParser()
    parser.add_argument('--logdir', help='log directory', default='log/train/superppo_v1_1')
    parser.add_argument('--savedir', help='save directory', default='trained_models/superppo')
...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        for iteration in range(args.iteration):
            ...
            print('Iter: ', iteration, ' score: ', sum(rewards))
            ...
            # print('iteration: ', iteration, ' beta: ', beta)
